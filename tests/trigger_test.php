...
/**
 * Trigger test for time created delay trigger.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tool_lifecycle_trigger_timecreateddelay_testcase extends \advanced_testcase {
    ...
    public function setUp() : void {
        ...
        $this->triggerinstance = \tool_lifecycle_trigger_timecreateddelay_generator::create_trigger_with_workflow();
    }
    ...
    public function test_young_course() {
        ...
        $course = $this->getDataGenerator()->create_course(array('timecreated' => time() - 50 * 24 * 60 * 60));
    ...
    public function test_old_course() {
        ...
        $course = $this->getDataGenerator()->create_course(array('timecreated' => time() - 200 * 24 * 60 * 60));
