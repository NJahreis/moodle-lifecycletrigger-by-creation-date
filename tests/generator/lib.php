...
/**
 * lifecycletrigger_timecreateddelay generator tests
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tool_lifecycle_trigger_timecreateddelay_generator extends testing_module_generator {

    /**
     * Creates a trigger timecreateddelay for an artificial workflow without steps.
     * @return trigger_subplugin the created timecreateddelay trigger.
    ...
    public static function create_trigger_with_workflow() {
        ...
        // Create trigger.
        $record = new stdClass();
        $record->subpluginname = 'timecreateddelay';
        $record->instancename = 'timecreateddelay';
