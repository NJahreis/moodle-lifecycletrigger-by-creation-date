...
/**
 * Subplugin for the creation time delay.
 *
 * @package lifecycletrigger_timecreated
...
class timecreateddelay extends base_automatic {
    ...
    public function extend_add_instance_form_definition($mform) {
        $mform->addElement('duration', 'delay', get_string('delay', 'lifecycletrigger_timecreateddelay'));
        $mform->addHelpButton('delay', 'delay', 'lifecycletrigger_timecreateddelay');
    }
